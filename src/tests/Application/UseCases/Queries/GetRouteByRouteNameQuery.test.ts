...
import {
  RouteQueryHandlerFactory
} from "../../../../Application/UseCases/Queries/GetRouteFromRouteNameQuery/RouteQueryHandlerFactory";
import {
  GetRouteByRouteNameQuery
} from "../../../../Application/UseCases/Queries/GetRouteFromRouteNameQuery/GetRouteByRouteNameQuery";
...
const routeQueryHandlerFactory = new RouteQueryHandlerFactory(
  routeService,
);
