...
const CalabresaCooker_1 = __importDefault(
  require("./strategy/CalabresaCooker")
);
...
const TuesdayWednesdayPromo_1 = __importDefault(
  require("./strategyPromo/TuesdayWednesdayPromo")
);
const ThursdayPromo_1 = __importDefault(
  require("./strategyPromo/ThursdayPromo")
);
